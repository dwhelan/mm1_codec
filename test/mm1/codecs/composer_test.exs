...
defmodule MM1.Codecs2.ComposerTest do
  ...
  use MM1.Codecs2.TestExamples,
      ...
      decode_errors: [
        {<<  0, 129, 130>>, {ShortInteger, {:most_signficant_bit_must_be_1, 0}}},
        {<<128,   0, 130>>, {ShortInteger, {:most_signficant_bit_must_be_1, 1}}},
        {<<128, 129,   0>>, {ShortInteger, {:most_signficant_bit_must_be_1, 2}}},
      ],

      encode_errors: [
        { [-1,  1,  2], {ShortInteger, {:must_be_an_integer_between_0_and_127, 0}}},
        { [ 0, -1,  2], {ShortInteger, {:must_be_an_integer_between_0_and_127, 1}}},
        { [ 0,  1, -1], {ShortInteger, {:must_be_an_integer_between_0_and_127, 2}}},
